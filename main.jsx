...
console.log('DROGUERIEPRO V36 ARABIC_PREMIUM_MOROCCO_DOCS OK');
...
function DocumentPreview({ L, type, doc, close }) {
  ...
  const docTitle = doc.stage === 'facture'
    ? L('invoiceTitle')
    : doc.stage === 'livraison'
      ? L('deliveryTitle')
      : doc.stage === 'reception'
